...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Free tier includes 3 credits. Pro plan is $19/month with 200 credits. Agency plan is $49/month with 700 credits. Each AI-generated proposal costs 1 credit. Manual writing is always free.",
  },
  {
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        ...
        <section className="mt-12 card p-8 text-center">
          ...
          <p className="text-ink-500 mb-6">
            Start with 3 free credits and generate your first outreach email in under a minute.
          </p>
