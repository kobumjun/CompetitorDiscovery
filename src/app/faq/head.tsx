const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Free tier includes 3 credits. Pro plan is $19/month with 200 credits. Agency plan is $49/month with 700 credits. Each AI-generated proposal costs 1 credit. Manual writing is always free.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "ProposalPilot only extracts publicly visible email addresses from websites. It does not access private databases, bypass login walls, or scrape social media profiles. Always follow applicable regulations and each site's terms when contacting organizations.",
      },
    },
    {
      "@type": "Question",
